...
pcd_load = o3d.io.read_point_cloud("<path to your point cloud (.ply) file>")
...
o3d.io.write_point_cloud("<file path where new point cloud will be stored>", inlier_cloud)

pcd_load = o3d.io.read_point_cloud("path to inlier cloud(.ply)")
